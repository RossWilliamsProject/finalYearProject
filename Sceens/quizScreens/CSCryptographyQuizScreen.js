...
import { QuestionsList } from "../../AppData/AppDataLists/CSCryptographyQuestionsList";
...
export default function CSCryptographyQuizScreen({ sessionScore, setSessionScore, showBadge01 }) {
